...
def num2cn(num, numbering_type=NUMBERING_TYPES[1], big=False, traditional=False, alt_zero=False, alt_two=False, use_zeros=True):
...
if __name__ == '__main__':
    ...
    print('num:', cn2num('两千万'))
    print('num:', cn2num('一亿六点三'))
    print('num:', cn2num('一亿零六点三'))
    print('num:', cn2num('两千零一亿六点三'))
    c = num2cn(023232.005184132423423423300, numbering_type='high', alt_two=True, big=False, traditional=True)
    print(c)
